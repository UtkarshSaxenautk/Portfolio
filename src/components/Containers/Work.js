...
const Work = () => {
    ...
    <li className="mb-10 ml-6">            
        ...
        <time className="block mb-2 text-sm font-normal leading-none text-gray-5600 dark:text-gray-200">08/2022 - Present</time>
                <p className="mb-4 text-base font-normal text-gray-700 dark:text-gray-400"><a aria-disabled
                 href='https://www.zaubacorp.com/company/YOGI-NETWORKS-LIMITED/U92132TN2003PLC051014' target='_blank' rel="noreferrer"> <b>Yogi Networks</b> <PublicIcon/> </a><ul>
    ...
    <li className="mb-10 ml-6">
        ...
        <p className="mb-4 text-base font-normal text-gray-700 dark:text-gray-400"><a aria-disabled
                 href='https://wizwack.in/' target='_blank' rel="noreferrer" > <b>Wizwack</b> <PublicIcon/> </a><ul>
